...
public class ReporterUtilTest {
    ...
    private static final String PARENT_DIR_PATH = Joiner.on(File.separatorChar).join(PARENT_DIR_PATH_PARTS);

    private static final URI BASE_URI = URI.create(FILE_PREFIX + PARENT_DIR_PATH + File.separatorChar + "src");
